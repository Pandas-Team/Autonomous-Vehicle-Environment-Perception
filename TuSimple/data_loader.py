...
class Generator(object):
    ...
    def __init__(self):
        ...
        with open("/root/Documents/LaneATT/PINet_new/TuSimple/dataset/five.json") as f:
            while True:
                line = f.readline()
                if not line:
                    break
        ...
        with open("/root/Documents/LaneATT/PINet_new/TuSimple/dataset/four.json") as f:
            while True:
                line = f.readline()
                if not line:
                    break
        ...
        with open("/root/Documents/LaneATT/PINet_new/TuSimple/dataset/three.json") as f:
            while True:
                line = f.readline()
                if not line:
                    break
        ...
        with open("/root/Documents/LaneATT/PINet_new/TuSimple/dataset/two.json") as f:
            while True:
                line = f.readline()
                if not line:
                    break
        ...
        # load test set
        self.test_data = []
        with open('/root/Documents/LaneATT/PINet_new/TuSimple/test_label.json') as f:
